 ...
 * The original class name was Transform, I changed to Transformation.
 * I added an invert() method and a lot of overloads for getters and setters.
 */
...
public class Transformation
{
    ...
    public void move(Vector3f position) { this.position = position.add(position); }
